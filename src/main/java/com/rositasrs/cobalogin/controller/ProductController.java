...
public class ProductController {
  ...
  @PostMapping("/upload")
  public ProductResponse uploadFile(@RequestParam("file") MultipartFile multipartFile) throws IOException {
  ...
  @PostMapping("/upload/tes")
  public void tes(@RequestParam("file") MultipartFile multipartFile, @RequestBody ProductDto productDto) throws IOException {
    ProductController tes1 = new ProductController();
    tes1.uploadFile(multipartFile);
    tes1.saveProduct(productDto);
  }
